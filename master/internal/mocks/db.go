...
// RBCheckpoint provides a mock function with given fields: _a0
func (_m *DB) RBCheckpoint(_a0 string) (*model.RBCheckpoint, error) {
	ret := _m.Called(_a0)

	var r0 *model.RBCheckpoint
	if rf, ok := ret.Get(0).(func(string) *model.RBCheckpoint); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*model.RBCheckpoint)
		}
	}
